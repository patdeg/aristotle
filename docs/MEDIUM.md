...
My youngest is twelve. He's what teachers politely call "people-smart" — sharp with faces, sharper with jokes, the kind of kid who can read a room before he walks into it. He is not, by any measure, math-smart.

He comes home from class looking a little lost. Not failing, exactly. Just… not arriving. The concepts glance off him. He says "I get it" when asked, and I can tell he doesn't. His teacher is good. His classroom has thirty-two other kids in it. The math is somewhere in the room, but it is not in him.

I've spent the last two years writing a book about what education could be — *The Unscarcity Project*. [Chapter 5](https://unscarcity.ai/a/chapter5) argues that the factory model of school, designed in 1843 Prussia to produce obedient soldiers and compliant bureaucrats, is finally obsolete. That every child in the post-scarcity world has a personal tutor — a Large Language Model taking the role Aristotle took for Alexander, one kid at a time, adapted to that kid's pace and passions.
...
The eyebrow went up a millimeter. She is not wrong to be skeptical. The internet is full of edtech that promises transformation and delivers screen time. I told her we'd try it for two weeks and if it wasn't helping, we'd stop.
...
This is his favorite thing about the worksheet now. He said the images help him "see it" — which I think is him describing immersion, the thing video games do for him and homework does not. He stares at the Viking jarl for thirty seconds before reading the problem. By the time he starts computing, he's already somewhere else.

It is pure Chapter 5:
...
He is twelve. He is not answering those questions yet. But he is learning that math is a thing you reach for when a story demands it. That is the shift. That is what the factory does not teach.
...
He stopped me. "Dad, I want to do all five." He was not performing for his mother. He was not trying to please me. He genuinely wanted to know how the story ended — which was, structurally, a word problem about how many strongbox keys a Crusader commander needed to distribute. But he wanted to know.
...
Chapter 5 argues that this is not incremental — it's the end of the factory model and the beginning of something else. [Education: Factory vs. Citizen](https://unscarcity.ai/a/education-factory-vs-citizen) puts the irony more sharply than I managed to:
...
Change the mentor's name if you want. Aristotle was my son's pick, but Socrates, Hypatia, Ada Lovelace, Confucius, Ibn Sina — any of them fits. Change the subject too. Math is the default but it works for science, social studies, language arts, foreign language. Put your kid's actual passion in the profile file and let the worksheet meet them where they actually live.

The tool is small. The bet is not:

If we're wrong about the factory — if this is not the end of it but just a rough patch — we lose nothing. Our kids get extra practice tailored to their interests. Worst case, a Sunday hike followed by an hour of Roman logistics with Dad.
...
My son has not turned into a math prodigy. He is twelve, and the worksheet is two pages once a week. But something moved. The eyebrow is still level. And the next time I was tired on a Sunday, I did not have to ask.
